...
sbatch --job-name=v --output=statistics/round_robin.out ./compute-SynSemDistances.sh case-studies/syntcomp-unreal/round_robin/round_robin_arbiter_unreal1_2_3.tlsf result-syntcomp-50-25-25/syntcomp-unreal/round_robin/round_robin-genuine
