...
public class SubformulaReplacer extends LTLParserBaseVisitor<Formula>{
	
	LabelledFormula src = null;
	LabelledFormula target = null;
//	LtlParseTreeVisitor ltl_visitor = null;
	List<String> variables = null;
	List<Literal> literalCache;
	boolean fixedVariables = false;
//	public SubformulaReplacer(Formula src, Formula target) {
//		super();
//		this.src = src;
//		this.target = target;
//		ltl_visitor = new LtlParseTreeVisitor();
//	}
	
	public SubformulaReplacer(LabelledFormula src, LabelledFormula target, List<String> variables) {
		super();
		this.src = src;
		this.target = target;
...
//		this.ltl_visitor = new LtlParseTreeVisitor(variables);
		

		
		ListIterator<String> literalIterator = variables.listIterator();
...
//	    fixedVariables = true;
	...
	public Formula visitAndExpression(AndExpressionContext ctx) {
		...
		if (ctx.getText().equals(src.toString()))
