...
public class FormulaParser extends LTLParserBaseVisitor<Formula> {
...
//	  }
	  ...
	  public FormulaParser(List<String> literals) {
	  ...
	  //we assume that propositions contains the index at the end.
