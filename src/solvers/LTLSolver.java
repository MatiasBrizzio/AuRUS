...
//        formula = toSolverSyntax(formula); // needed because the string generated by OWL
        // puts together temporal operators and the variable, and the solvers inteprets that as a variable.
